...
def single_gpu_test(model,
                    ...
                    show=False,
                    out_dir=None,
                    show_score_thr=0.3, classifier=None):
    model.eval()
    results = []
        ...
        if show or out_dir:
            ...
            if normal:
                ...
                for j in range(7):
                    ...
                    # for j, instance in enumerate(result[i]):
                        # if instance[-1] < keep_threshold: #score
                    result[0][j] = np.array([]).reshape(0,5)
                # pdb.set_trace()
